...
class FeatureEngineer:
    ...
    def _initialize_patterns(self):
        ...
        self.color_terms = ['red', 'blue', 'black', 'white', 'navy', 'beige']
        self.material_terms = ['cotton', 'polyester', 'silk', 'wool', 'linen']
        self.style_terms = ['formal', 'casual', 'sporty', 'vintage']
        
        # Create phrase matchers
        self.color_matcher = PhraseMatcher(self.nlp.vocab)
        self.material_matcher = PhraseMatcher(self.nlp.vocab)
        self.style_matcher = PhraseMatcher(self.nlp.vocab)
        
        for term_list, matcher in [
            (self.color_terms, self.color_matcher),
            (self.material_terms, self.material_matcher),
            (self.style_terms, self.style_matcher)
        ]:
    ...
    def extract_features(self, text: str) -> Dict:
        ...
        features = {
            ...
            'styles': [],
            'negations': [],
            'measures': self._extract_measures(doc)
        }
